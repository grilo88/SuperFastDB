...
Para atingirmos o melhor desempenho e estar sempre a frente de outros bancos de dados é necessário ter uma mentalidade voltada para a programação estruturada do que orientada a objetos, apesar de fazermos o uso dos dois paradigmas, deixando a orientada a objetos sempre em último caso quando não há alternativas.
